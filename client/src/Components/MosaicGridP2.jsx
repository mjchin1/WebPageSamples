...
export default function MosaicGridP2() {
  ...
  return (
    ...
    <div className= "mg2Block navy"><div className="mg2InnerBorder"><h2>Our food is the best.</h2> </div></div>
    ...
    <div className="mgp2ContentBlock1">
    <div className= "mg2Block darkGreen"><div className="mg2InnerBorder"><h2>We create experiences that you and your loved ones will remember forever.</h2></div></div>
    ...
    <div className="mgp2ContentBlock1">
    <div className= "mg2Block maroon"><div className="mg2InnerBorder"><h2>We put a ton of heart into everything we do.</h2></div></div>
